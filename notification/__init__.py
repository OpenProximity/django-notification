VERSION = (0, 1, 5, "-final-openproximity")
...
try:
    ...
    NOTIFICATION_USE_SITE = getattr(settings, 
                                    'NOTIFICATION_USE_SITE',
                                    False)
    NOTIFICATION_QUEUE_ALL = getattr(settings, 
                                     "NOTIFICATION_QUEUE_ALL", 
                                     False)
    NOTIFICATION_LANGUAGE_MODULE = getattr(settings, 
                                           'NOTIFICATION_LANGUAGE_MODULE', 
                                           False)
    NOTIFICATION_FEEDS = getattr(settings, 
                                 "NOTIFICATION_FEEDS", 
                                 False)
